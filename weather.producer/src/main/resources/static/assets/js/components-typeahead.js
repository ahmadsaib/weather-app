var ComponentsTypeahead = function () {
    ...
    var handleTwitterTypeahead = function () {
        ...
        var custom = new Bloodhound({
            ...
            queryTokenizer: Bloodhound.tokenizers.whitespace,
            remote: {
                url: '../ezpzsehat/suggestions/typeahead_custom.php?query=%QUERY',
                wildcard: '%QUERY'
            }
        });
...
//        if (App.isRTL()) {
//            $('#looking_for').attr("dir", "rtl");
//        }
        $('#looking_for').typeahead(null, {
            name: 'looking_for',
            displayKey: 'value',
        ...
        // Example #3
        var custom1 = new Bloodhound({
            datumTokenizer: function (d) {
                return d.tokens;
            },
            queryTokenizer: Bloodhound.tokenizers.whitespace,
            remote: {
                url: '../demo/typeahead_custom_loc.php?query=%QUERY',
                wildcard: '%QUERY'
            }
        });
...
//            $('#where').attr("dir", "rtl");
//        }
//        $('#where').typeahead(null, {
//            name: 'where',
//            displayKey: 'value',
//            source: custom1.ttAdapter(),
//            hint: (App.isRTL() ? false : true),
//            templates: {
//                suggestion: Handlebars.compile([
//                    '<p>{{value}}</p>',
